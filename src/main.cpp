...
{
  public:
    void Start() override { SetFillColor(0, 255, 0, 0); }
};
...
class Paddle : public RectRenderObject
{
  ...
  public:
    void Start() override
    {
        ...
        SetRect(0, (game->GetHeight() / 2) - (rect->h / 2));
    }
};
...
class RightPaddle : public Paddle
{
  public:
    void Start() override
    {
        ...
        SetRect(game->GetWidth() - rect->w - size, rect->y);
    }
  ...
  public:
    void Start() override
    {
        ...
        leftScoreText->LoadFontRW(fonts_JustMyType_JustMyType_ttf,
                                  ...
                                  fontSize);
        leftScoreText->SetColor({255, 255, 255, 255});
        ...
        rightScoreText->LoadFontRW(fonts_JustMyType_JustMyType_ttf,
                                   fonts_JustMyType_JustMyType_ttf_len,
                                   fontSize);
        rightScoreText->SetColor({255, 255, 255, 255});
