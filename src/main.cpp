...
class GameManager : public RenderObject
{
  ...
  public:
    ...
    void Update(double deltaTime) override
    {
        ...
        if (SDL_HasIntersectionF(&leftPaddle->GetRect(),
                                 &ballCalculatedNextRect) == SDL_TRUE ||
            SDL_HasIntersectionF(&rightPaddle->GetRect(),
                                 &ballCalculatedNextRect) == SDL_TRUE)
        {
            ball->ChangeDirection();
        }

        if (SDL_HasIntersectionF(&leftBorderCollider->GetRect(),
                                 &ballCalculatedNextRect) == SDL_TRUE)
        {
        ...
        else if (SDL_HasIntersectionF(&rightBorderCollider->GetRect(),
                                      &ballCalculatedNextRect) == SDL_TRUE)
        {
